...
// ================================================================================
// 3D CITY BACKGROUND - Three.js WebGL Scene
// ================================================================================
...
(function init3DCity() {
    ...
    if (!canvas) {
        console.error('Canvas element #city-canvas not found');
        return;
    }
    ...
    var camera = new THREE.PerspectiveCamera( 20, containerRect.width / containerRect.height, 1, 500 );
    ...
    // START functions
    console.log('%c✓ 3D City initializing...', 'color: #17f7f7; font-size: 12px;');
    generateLines();
    initCity();
    animate();
    console.log('%c✓ 3D City animation started!', 'color: #17f7f7; font-size: 12px;');
})();
